...
Program::Program()
    : mWindow(
      ...
      // [CHANGE 3] Initialize the manager
      mIncomeManager(), 
      mExpenseManager(),

      // [CHANGE 4] Pass mIncomeManager to the Context constructor
      // This matches the update you just made in State.cpp
      mStateStack(State::Context(mWindow, mTextureHolder, mFontHolder, mIncomeManager,mExpenseManager))
{
